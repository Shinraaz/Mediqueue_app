...
class _HomeScreenState extends State<HomeScreen>
            ...
            child: CustomScrollView(slivers: [
              SliverToBoxAdapter(
                  child: FadeTransition(
                      ...
                      child: SlideTransition(
                          position: _slide,
                          child: _hero(context, user.firstName)))),
              SliverPadding(
              ...
              SliverPadding(
                  ...
                  sliver: SliverToBoxAdapter(
                      child: _quickActions(context, user.name))),
              SliverPadding(
              ...
              upcoming.isEmpty
                  ? SliverPadding(
                      ...
                      sliver: SliverToBoxAdapter(
                          child: _emptyCard(context, user.name)))
                  : SliverPadding(
                      ...
                      sliver: SliverList(
                          delegate: SliverChildBuilderDelegate(
                              (_, i) => Padding(
                                  ...
                                  child: _apptCard(context, upcoming[i])),
  ...
  Widget _stats(List<Appointment> upcoming) {
    final today = upcoming
        ...
        .length;
    return Row(children: [
      _stat('Upcoming', '${upcoming.length}', Icons.schedule_rounded,
          AppTheme.primary),
      const SizedBox(width: 12),
      _stat('Today', '$today', Icons.today_rounded, AppTheme.primaryDark),
      const SizedBox(width: 12),
      _stat('Doctors', '${seedDoctors.length}', Icons.medical_services_outlined,
  ...
  Widget _quickActions(BuildContext context, String patientName) =>
        ...
        Row(children: [
          _action(
              ...
              () => Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (_) =>
                              BookAppointmentScreen(patientName: patientName)))
                  .then((_) => setState(() {}))),
          const SizedBox(width: 12),
          _action(
              '🩺',
  ...
  Widget _action(String emoji, String label, Color color, VoidCallback onTap) =>
      Expanded(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          Row(children: [
            ...
            Text(DateFormat('MMM d, y').format(a.date),
                style:
